...
<div class="col-lg-6">
<span class="logo">The X-LAB</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<h2 align="center" style="font-family:'typo'; color:#000066">About The X-LAB</h2>
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by The X-LAB, Sharda University, Place<br><br></span></div>
<div class="col-md-2 box">
<a href="feedback.php" style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">Feedback</a></div>
<div class="col-md-2 box">
<span href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About The X-LAB</span></div>
</div>
</body>
</html>
