...
<span href="#" data-target="#login" style="color:lightyellow">Organized by The X-LAB, Institute's Name, Place<br><br></span></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">About The X-LAB</a></div>
</div>
</body>
</html>
